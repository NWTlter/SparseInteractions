...
EnvCol <- 67  # 72 for Canopy or 71 for Phosphorous
...
AllSpAbunds <- all_dat[,3:65]
AllSpNames <- names(all_dat[,3:65])
...
PrelimFit <- stan(file = here("BH_simulations/Main/StanCode/Prelim_monoLambda_envAlpha.stan"), data = DataVec, iter = 1000, chains = 3, control = list(adapt_delta = 0.9))
