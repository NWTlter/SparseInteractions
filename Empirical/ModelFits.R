...
PrelimFit <- stan(file = here("Empirical/StanCode/BH_FH_Preliminary.stan"), data = DataVec, iter = 30, 
                  chains = 3)
...
FinalFit <- stan(file = here("Empirical/StanCode/BH_Final.stan"), data = DataVec, iter = 100, chains = 3)
